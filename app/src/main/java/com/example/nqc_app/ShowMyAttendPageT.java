        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.btnAttendShowAll:
                    ...
                    final SimpleAdapter ShowAttendList = new SimpleAdapter(ShowMyAttendPageT.this,AllShowAttendADA,R.layout.activity_showattendlist_itme,from2,AttendListView); //設定資料陣列
                    //設定陣列指向
                    listAttend.setAdapter(ShowAttendList);
                    ShowAttendList.notifyDataSetChanged();
                    txtShowAttend.setText("目前清單顯示狀態：顯示全部");
                    Toast.makeText(ShowMyAttendPageT.this,"老師版!",Toast.LENGTH_SHORT).show();
                    break;
    ...
    public class DBGetUserAttend extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String z){
            ...
            if(isSuccess){
                int[] AttendListView = {R.id.txtShowAttendListDay,R.id.txtShowAttendListStatue}; //設定顯示清單元件
                String[] from2 = {"簽到日期","出席狀況"};
                 SimpleAdapter ShowAttendList = new SimpleAdapter(ShowMyAttendPageT.this,AllShowAttendADA,R.layout.activity_showattendlist_itme,from2,AttendListView); //設定資料陣列
                //設定陣列指向
                listAttend.setAdapter(ShowAttendList);
                ShowAttendList.notifyDataSetChanged();
            }
    ...
    public class DBGetUserSelectClassList extends  AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String z){
            if(isSuccess){
                int[] AttendListView = {R.id.txtShowAttendListDay,R.id.txtShowAttendListStatue}; //設定顯示清單元件
                String[] from2 = {"簽到日期","出席狀況"};
                final SimpleAdapter ShowAttendList = new SimpleAdapter(ShowMyAttendPageT.this,SelectShowAttendADA,R.layout.activity_showattendlist_itme,from2,AttendListView); //設定資料陣列
                //設定陣列指向
                listAttend.setAdapter(ShowAttendList);
                ShowAttendList.notifyDataSetChanged();
            }
